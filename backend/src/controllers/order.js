...
export const getAllOrders = async (req, res) => {
  console.log("enter for getting all orders");
  try {
    const orders = await prisma.order.findMany({
      include: {
        buyer_status: true, // Fetch buyer details
        seller_status: true, // Fetch seller details
        orderPayment: true, // Fetch payment details
        userReview: true, // Fetch reviews
      },
    });

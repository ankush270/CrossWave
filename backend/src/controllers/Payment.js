...
export const verifyPayment = async (req, res) => {
  ...
  try {
    ...
    const generatedSignature = crypto
      .createHmac("sha256", "AIyIJ88xFIWUJvoco5WELwIT")
      .update(body)
      .digest("hex");
...
export const createPaymentDoc = async (details) => {
  // const { razorpay_payment_id,razorpay_order_id, razorpay_signature, status, orderId, amount, paymentMethod } = details;
  try {

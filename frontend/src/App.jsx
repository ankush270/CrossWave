      ...
      <AuthProvider>
        <div className="min-h-screen flex flex-col">
          ...
          <main className="flex-grow">
            ...
            {/* Buyer Routes */}
            <Route path="/buyer/dashboard" element={<ProtectedRoute requiredRole={"buyer"}><Buyer /></ProtectedRoute>} />

            {/* Seller Routes */}
            <Route path="/seller/dashboard" element={<ProtectedRoute requiredRole={"seller"}><Seller /></ProtectedRoute>} />

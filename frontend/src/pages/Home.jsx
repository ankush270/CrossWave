...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const sections = ["features", "steps", "testimonials"].map((id) =>
  ...
  const testimonials = [
    {
      ...
      image: img1,
      quote:
        "CrossWave has revolutionized how we handle international trade. The platform is intuitive and the support is exceptional.",
      companyLogo: c1,
    },
    {
      name: "Michael Chen",
      ...
      image: img2,
      quote:
        "The real-time tracking and compliance features have saved us countless hours and reduced our operational costs significantly.",
      companyLogo: c2,
    },
    {
      name: "Emma Rodriguez",
      ...
      image: img3,
      quote:
        "Documentation and compliance used to be a nightmare. With CrossWave, everything is streamlined and automated.",
      companyLogo: c3,
    },
  ];

    ...
    if (currentFeature.trim()) {
      setData(prev => ({
        ...
        pricing: {
          ...
          [tier]: {
            ...prev.pricing[tier],
            features: [...prev.pricing[tier].features, currentFeature.trim()]
          }
        }
      }));
      setCurrentFeature('');
  ...
  const addSpecification = () => {
    if (currentSpec.key && currentSpec.value) {
      setData(prev => ({
        ...
        specifications: {
          ...prev.specifications,
          [specType]: [...prev.specifications[specType], { ...currentSpec }]
        }
      }));
